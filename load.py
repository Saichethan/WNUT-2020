...
def load_data():
	bert_train = pickle.load(open('embeddings/bert_train.np', 'rb'))
	bert_val = pickle.load(open('embeddings/bert_val.np', 'rb'))
	bert_test = pickle.load(open('embeddings/bert_test.np', 'rb'))
